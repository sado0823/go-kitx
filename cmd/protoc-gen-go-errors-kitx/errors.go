...
import (
	...
	"github.com/sado0823/go-kitx/cmd/protoc-gen-go-errors-kitx/errors"
...
const (
	errorsPackage = protogen.GoImportPath("github.com/sado0823/go-kitx/errorx")
	fmtPackage    = protogen.GoImportPath("fmt")
)

var enCases = cases.Title(language.AmericanEnglish, cases.NoLower)

// generateFile generates a _errors.pb.go file containing kitx errors definitions.
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.P("// Code generated by protoc-gen-go-errors-kitx. DO NOT EDIT.")
	g.P()
...
// generateFileContent generates the kitx errors definitions, excluding the package statement.
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	...
	g.P("var _ error = (*", errorsPackage.Ident("Error"), ")(nil)")
	g.P()
	index := 0
